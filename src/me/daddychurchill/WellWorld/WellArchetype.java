...
public abstract class WellArchetype {
	...
	public WellArchetype(World world, long seed, int wellX, int wellZ) {
		...
		this.minBlock = new Vector(x1 + WellWorldChunkGenerator.wallThicknessInBlocks, 1,
				z1 + WellWorldChunkGenerator.wallThicknessInBlocks);
		this.maxBlock = new Vector(x2 - WellWorldChunkGenerator.wallThicknessInBlocks,
				127/* world.getMaxHeight() - 1 */, z2 - WellWorldChunkGenerator.wallThicknessInBlocks);
	}
	...
	protected void drawSolidSphere(World world, Chunk chunk, int centerX, int centerY, int centerZ, int radius,
			Material material) {
	...
	protected void drawSolidSphere(World world, Chunk chunk, int centerX, int centerY, int centerZ, int radius,
			Material fillMaterial, int floodY, Material floodMaterial) {
		Vector center = new Vector(centerX, centerY, centerZ);
		Material material;
